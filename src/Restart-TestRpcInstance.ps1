Param([string] $workingDir = '.', [string]$port, [string]$environmentCode, [string]$networkid)

# Script that runs on the Azure VM to restart testrpc instance
# This is called as part of the Release
